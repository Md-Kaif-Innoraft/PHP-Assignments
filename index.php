      ...
      if (empty ($email)) {
        ...
        return "";
          ...
          if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            // Execute the curl request and store the response data.
            $data = curl_exec($ch);
            // Close the curl session.
            curl_close($ch);
            // Decode the JSON response data into an associative array.
...
<body>
    <div class="container">
      <div class="box">
        ...
        <input type="text" name="fname" id="fname" maxlength="20" value="<?php echo $_POST['fname']; ?>" required pattern="[a-zA-Z ]*">
        <span class="error" id="ferror"><?php echo " $fnameErr <br><br>"; ?></span>
        ...
        <span class="error" id="lerror"><?php echo "$lnameErr <br><br>"; ?></span>
        ...
        <span class="error" id="nerror"><?php echo "$numErr <br> <br>"; ?></span>

        <label for="email"><span class="error">* </span> Email : <span class="success"><?php echo "$emailSuccess"; ?></span></label> <br>
        <input type="text" id="email" name="email"value="<?php echo $_POST['email']; ?>" required> <br>
        <span class="error" id="emailErr"><?php echo "$emailErr <br> <br>"; ?></span>

        <label for="sub">Subjects and Marks : ( Format: English|80)</label>
        <textarea required name="sub" id="sub" rows="3"></textarea>
        <span class="error" id="serror"><?php echo $tableErrMsg; ?><br><br></span>
