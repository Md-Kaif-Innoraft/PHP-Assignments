...
function validateMarks(inputId, errorId, fieldName){
...
function validate(){
    ...
    var number = validateInputs("number", "nerror", "Phone Number", 10, numberRegex) ;
    ...
    var marks = validateMarks("sub", "serror", "Marks");
    
    return fnameValid && lnameValid && number && marks;
