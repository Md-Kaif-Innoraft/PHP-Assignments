...
class FormValidator {
   ...
   *
   * @return string
   *  Returns Temporary file naem of image.
   */
   ...
   *
   * @return string
   *  Return data string after performing operations.
   */
   ...
   *
   * @return string
   *  Return input after validation is success else empty string.
   */
